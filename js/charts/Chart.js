...
module.exports = function(Chart) {
	...
	// Scatter charts use line controlleurs
...
module.exports = function(Chart) {
	...
	helpers.extend(Chart.prototype, /** @lends Chart */ {
		...
		initialize: function() {
			...
			// Make sure scales have IDs and are built before we build any controlleurs.
		...
		*/
		...
		update: function(animationDuration, lazy) {
			...
			// Make sure dataset controlleurs are updated and new controlleurs are reset
			var newControllers = me.buildOrUpdateControllers();

			// Make sure all dataset controlleurs have correct meta data counts
			helpers.each(me.data.datasets, function(dataset, datasetIndex) {
			...
			// Can only reset the new controlleurs after the scales have been updated
		...
		destroy: function() {
			...
			// dataset controlleurs need to cleanup associated data
...
module.exports = function(Chart) {
	...
	// Base class for all dataset controlleurs (line, bar, etc)
...
module.exports = function(Chart) {
	...
	function computeBoundary(source) {
		...
		// controlleurs might still use it (e.g. the Smith chart).
